...
public class ShopController {
    ...
    @GetMapping("/user/shop/status") public ApiResponse<Map<String,Object>> status(){Map<String,Object> out=new HashMap<>();out.put("status",jdbc.queryForObject("select status from shop_state where id=1",Integer.class));out.put("name","山岚食集");return ApiResponse.ok(out);}
